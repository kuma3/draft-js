...
var DraftEditorContents = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        blockKeyRestoreMap = _this$props.blockKeyRestoreMap;
    ...
    for (var ii = 0; ii < blocksAsArray.length; ii++) {
      ...
      console.log(key);
      console.log("".concat(key, " - ").concat(blockKeyRestoreMap.get(key) || '0'));
      var child = React.createElement(Element, childProps, React.createElement(Component, _extends({}, componentProps, {
        key: "".concat(key, " - ").concat(blockKeyRestoreMap.get(key) || '0')
      })));
