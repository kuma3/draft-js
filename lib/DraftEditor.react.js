...
var DraftEditor = /*#__PURE__*/function (_React$Component2) {
  ...
  function DraftEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "restoreEditorBlockDOM", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "restoreEditorBlockDOM", function (blockKey, scrollPosition) {
      var blockKeyRestoreMap = _this.state.blockKeyRestoreMap;
      blockKeyRestoreMap = blockKeyRestoreMap.set(blockKey, blockKeyRestoreMap.has(blockKey) ? blockKeyRestoreMap.get(blockKey) + 1 : 1); // Wrap state updates in `flushControlled`. In sync mode, this is
      // effectively a no-op. In async mode, this ensures all updates scheduled
      // inside are flushed before React yields to the browser.
      ...
      if (flushControlled) {
        flushControlled(function () {
          return _this.setState({
            blockKeyRestoreMap: blockKeyRestoreMap
          }, function () {
            _this.focus(scrollPosition);
          });
        });
  ...
  _proto2.render = function render() {
    ...
    var blockKeyRestoreMap = this.state.blockKeyRestoreMap;
    var rootClass = cx({
